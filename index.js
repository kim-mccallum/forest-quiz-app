...
const STORE = [
   ...
   {question:"Which of the following statements describes another important role of forests?",
    ...
    options: ["Trees use a network of soil fungi to communicate their needs and aid neighboring plants.","Trees that are in distress can send chemical signals through the air to ‘warn’ other trees of the danger.","Both are actually true!"],
...
function renderAQuestion() {
    // Pick a question from the STORE array and render it
    debugger;
...
function updateOptions() {
    console.log("updateOptions ran");
}

// Display question number and score obtained and increment questionNumber
function updateQuestionAndScore() {
    questionNumber++;
    console.log("updateQuestionAndScore ran");
}

// Display results and restart the quiz
...
// Check to see if you've reached the end of STORE
function handleQuestions() {
    // Listen for click on next question
    // If you aren't at the end, renderAQuestion();
    console.log("handleQuestions ran");
}

// Checks to see if chosen option/answer is correct/incorrect and displays the corresponding message
function handleSelectOption() {
    console.log("handleSelectOption ran");
}

function restartQuiz() {
    //Listen for a click on restart
    renderAQuestion();
